...
# try and except block, we can include a finally block at the end. 
# The finally block is always executed, so it is generally used for
# doing the concluding tasks like closing file resources 
